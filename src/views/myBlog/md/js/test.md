> - 底层基于 postMessage 实现通信，未做 ie 兼容性处理
...
- `publish`：发布页面，入参支持 String 或 Object, 返回值为发布链接
...
- `setTab`：设置 PAGE 的 tab，参数为"content"、"history"、"template"、"search"、"list"、"help"、"info"其中之一
